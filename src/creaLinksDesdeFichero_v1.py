...
NAS      = '192-168-1-130.totemtowers.direct.quickconnect.to' #https://192-168-1-130.totemtowers.direct.quickconnect.to:15005/
NAS_PORT = '15005'
Account  = 'creaLinks' #str (os.getenv ("SynoShareAccount"));
Passwd   = 'Cr34L1nks_0' #str (os.getenv ("SynoSharePasswd"));
RootPath = '/192.168.1.130/DocOperaciones/Legacy_Big_Files/'
...
def main():
    ...
    fileEntrada="src/entrada.txt"
    fileSalida="src/salida.txt"
    fileSalidaError="src/salidaError.txt"
    dir  = '/DocOperaciones/Legacy_Big_Files/'
